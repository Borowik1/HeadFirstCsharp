...
{    
    public partial class Form1 : Form
    {
        ...
        private void getIngredientButton_Click(object sender, EventArgs e)
        {
        ...
        private void getSuzanneDelegateButton_Click(object sender, EventArgs e)
        {
            ingredientMethod = new GetSecretIngredient(suzanne.MySecretIngredientMethod);
        }

        private void getAmyDelegateButton_Click(object sender, EventArgs e)
        {
